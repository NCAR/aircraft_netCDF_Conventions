...
```cdl
float ACDP_LWOO(Time, sps1, Vector30)   /* current */
float ACDP_LWOO(Time, sps1, Vector31)   /* legacy */
```
...
```cdl
float CCDP_LWOO(Time, sps1, Vector30)   /* current */
float CCDP_LWOO(Time, sps1, Vector31)   /* legacy */
```
